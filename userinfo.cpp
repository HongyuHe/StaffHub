...
bool UserInfo::checkLoginInfo (QString userName, QString userPswd)
{
    QSqlQuery query;
...
bool UserInfo::checkRegisterInfo (QString userName)
{
    QSqlQuery query;
    QString queryString = QString("select * from Admin");
...
//添加新用户：
bool UserInfo::addNewUser (QString UserName, QString UserPswd)
{
    QSqlQuery query;
